...
describe("ServiceRegistry", () => {
  ...
  it("should have get method", () => {
    expect(ServiceRegistry).toHaveProperty("get");
  });
  it("should have has method", () => {
    expect(ServiceRegistry).toHaveProperty("has");
  });
  it("should have register method", () => {
    expect(ServiceRegistry).toHaveProperty("register");
  });
  it("should register service", () => {
    class Test {}
    ServiceRegistry.register(Test, { name: "Test", dependencies: [] });
    expect(ServiceRegistry.has(Test)).toBe(true);
  });
  it("should get service", () => {
    class Test {}
    ServiceRegistry.register(Test, { name: "Test", dependencies: [] });
    expect(ServiceRegistry.get(Test)).toEqual({
      name: "Test",
      dependencies: [],
    });
  });
  ...
  it("should be empty after GC", () => {
    ...
    for (let i = 0; i < 1000; i++) {
      ServiceRegistry.register(createComplexClass(), {
        name: "Test",
        dependencies: [],
      });
    }
